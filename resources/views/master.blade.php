...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title != '' ? $title : 'Big Post Journal' }}</title>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 xl:max-w-5xl xl:px-0">
            ...
            <div class="container mx-auto px-6 py-16">
                ...
                <div class="pt-6 pb-8 space-y-2 md:space-y-5 ">
                    <a href="/"><h3 class="text-3xl leading-9 font-extrabold text-gray-900 tracking-tight sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">{{ $title_page }}</h3></a>
                    <p class="text-lg leading-7 text-gray-500">{{ isset($header_span) ? $header_span : '' }}</p>
                </div>
